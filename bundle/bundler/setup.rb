...
$:.unshift File.expand_path("#{path}/../#{ruby_engine}/#{ruby_version}/gems/directory_watcher-1.5.1/lib")
$:.unshift File.expand_path("#{path}/../#{ruby_engine}/#{ruby_version}/gems/kramdown-0.14.2/lib")
$:.unshift File.expand_path("#{path}/../#{ruby_engine}/#{ruby_version}/gems/liquid-2.5.0/lib")
...
$:.unshift File.expand_path("#{path}/../#{ruby_engine}/#{ruby_version}/gems/pygments.rb-0.3.7/lib")
$:.unshift File.expand_path("#{path}/../#{ruby_engine}/#{ruby_version}/gems/jekyll-0.12.1/lib")
